...
} // function yang didalam nya mempunyai method
...
*/
    ...
    class Character {
        constructor (name, healty, position){
            this.name = name;
            this. healty = healty;
            this.position = position;
        }
    ...
    function canAttack (character){ // function biasa
        return {
            attack: () => {
    ...
    const canDefend = (character) =>{ // arrow function
        return {
            defend: () => {
    ...
    const canCastSpell = function (character){ // function expression
        return {
            castSpell: () => {
...
//https://www.dicoding.com/academies/256/tutorials/15988